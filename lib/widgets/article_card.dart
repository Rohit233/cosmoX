                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(DateTimeUtils.getFormatedDateFromEpoch(widget.articleModel.publishedAt.millisecondsSinceEpoch)),
                                  ],
                                ),
                                Padding(
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(DateTimeUtils.getFormatedTimeFromEpoch(widget.articleModel.publishedAt.millisecondsSinceEpoch)),
                                  ],
                                ),
                              ],
                            ),
                            Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    Icon(Icons.calendar_today_outlined),
                                    Text(DateTimeUtils.getFormatedDateFromEpoch(widget.articleModel.updatedAt.millisecondsSinceEpoch)),
                                  ],
                                ),
                                Padding(
                                  padding: EdgeInsets.only(top:8.0,bottom: 8.0),
                                ...
                                Row(
                                  children: [
                                    Icon(Icons.watch_outlined),
                                    Text(DateTimeUtils.getFormatedTimeFromEpoch(widget.articleModel.updatedAt.millisecondsSinceEpoch)),
                                  ],
                                ),
                              ],
                            ),
